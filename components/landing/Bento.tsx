      ...
      <div className="mx-auto mb-5 max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-10 grid gap-4 sm:mt-16 lg:grid-cols-3 lg:grid-rows-2">
          <div className="relative lg:row-span-2">
            <div className="absolute inset-px rounded-lg bg-white dark:bg-[oklch(0.205_0_0)] lg:rounded-l-4xl"></div>
            <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(var(--radius-lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
              ...
              <div className="@container relative min-h-120 w-full grow max-lg:mx-auto max-lg:max-w-sm">
                <div className="absolute inset-x-10 top-10 bottom-0 overflow-hidden rounded-t-[10cqw] border-x-[3cqw] border-t-[3cqw] border-gray-950 shadow-2xl dark:bg-white">
                  <img
          ...
          <div className="relative max-lg:row-start-1">
            <div className="absolute inset-px rounded-lg bg-white dark:bg-[oklch(0.205_0_0)] max-lg:rounded-t-4xl"></div>
          ...
          <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
            <div className="absolute inset-px rounded-lg bg-white dark:bg-[oklch(0.205_0_0)]"></div>
          ...
          <div className="relative lg:row-span-2">
            <div className="absolute inset-px rounded-lg bg-white dark:bg-[oklch(0.205_0_0)] max-lg:rounded-b-4xl lg:rounded-r-4xl"></div>
