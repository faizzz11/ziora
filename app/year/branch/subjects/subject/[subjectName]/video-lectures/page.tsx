      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Videos Not Available</h1>
            <p className="text-gray-600 mb-8">Video content for this subject is not available yet.</p>
      ...
      <section className="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-gray-900 font-medium">Video Lectures</span>
          </nav>
        </div>
      </section>
